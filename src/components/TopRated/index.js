...
class TopRated extends Component {
  ...
  renderFailureView = () => (
    <div className="failureViewContainer">
      <img
        src="https://res.cloudinary.com/dfhxhfcej/image/upload/v1676299476/Movies%20App%20-%20REACTJS/alert-triangle_afua5n.png"
        className="warning"
        alt="warning sign"
      />
      <p className="reason">Something went wrong. Please Try Again</p>
      <button type="button" onClick={this.onRetry} className="try-again">
        Try Again
      </button>
    </div>
  )
